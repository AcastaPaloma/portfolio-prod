...
The page begins in black. Compact identity copy, including current computer vision inference work at Reflex and Piñata Pitch's 2000+ student ideas, and the minifigure share the opening; work follows beside the particle helmet. Projects include GNN Quantum Error Decoder, Cortesol, and MvPvP. People contains Piñata Pitch, Morgan Stanley, and Around the dot. Elsewhere combines eight owner-selected travel photographs with three retained camera-roll images. The calendar invitation belongs in the opening links, alongside résumé, LinkedIn, and email.
